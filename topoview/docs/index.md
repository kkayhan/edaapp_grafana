...
| **Catalog**          | [kkayhan/eda-catalog/topoview][manifest] |
| **Source Code**      | [kkayhan/edaapp_grafana][src]           |

[manifest]: https://github.com/kkayhan/eda-catalog/tree/main/apps/topoview.eda.edacommunity.com
[src]: https://github.com/kkayhan/edaapp_grafana

Turn any EDA-managed fabric into a live Grafana **topology map** — automatically.
TopoView bundles a Prometheus + Grafana stack (no Loki — EDA has native logging),
...
* **TopoViewConfig** — cluster-scoped global tuning (refresh interval, excluded
